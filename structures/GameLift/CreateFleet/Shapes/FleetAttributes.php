 ...
 * @property ResourceCreationLimitPolicy $ResourceCreationLimitPolicy
 * @property list<string> $MetricGroups
 * @property list<'AUTO_SCALING'> $StoppedActions
 * @property string $InstanceRoleArn
 * @property CertificateConfiguration $CertificateConfiguration
 * @property 'EC2'|'ANYWHERE' $ComputeType
 * @property AnywhereConfiguration $AnywhereConfiguration
