 ...
 * @property 'ON_DEMAND'|'SPOT' $FleetType
 * @property string $InstanceRoleArn
 * @property Shapes\CertificateConfiguration $CertificateConfiguration
 * @property list<Shapes\LocationConfiguration> $Locations
 * @property list<Shapes\Tag> $Tags
 * @property 'EC2'|'ANYWHERE' $ComputeType
 * @property Shapes\AnywhereConfiguration $AnywhereConfiguration
 * @property 'SHARED_CREDENTIAL_FILE' $InstanceRoleCredentialsProvider
 */
class CreateFleetRequest extends Request
{
     ...
     *     EC2InboundPermissions?: list<Shapes\IpPermission>,
     ...
     *     CertificateConfiguration?: Shapes\CertificateConfiguration,
