...
namespace Sunaoka\Aws\Structures\GameLift\DescribeEC2InstanceLimits\Shapes;
 ...
 * @property int<0, max> $CurrentInstances
 * @property int<0, max> $InstanceLimit
 * @property string $Location
 */
class EC2InstanceLimit extends Shape
{
    /**
     * @param array{
     ...
     *     CurrentInstances?: int<0, max>,
     *     InstanceLimit?: int<0, max>,
     *     Location?: string
     * } $args
     */
