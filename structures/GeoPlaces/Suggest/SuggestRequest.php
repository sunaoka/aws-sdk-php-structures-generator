 ...
 * @property list<'Core'|'TimeZone'|'Phonemes'|'Access'|'CrossReferences'>|null $AdditionalFeatures
...
class SuggestRequest extends Request
{
     ...
     *     AdditionalFeatures?: list<'Core'|'TimeZone'|'Phonemes'|'Access'|'CrossReferences'>|null,
