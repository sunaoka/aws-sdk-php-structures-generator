...
namespace Sunaoka\Aws\Structures\TranscribeService\ListMedicalVocabularies\Shapes;
 ...
 * @property 'PENDING'|'READY'|'FAILED' $VocabularyState
 */
class VocabularyInfo extends Shape
{
    /**
     * @param array{
