 ...
 * @property EnvironmentConfigDetails|null $EnvironmentConfig
 */
class ClusterRestrictedInstanceGroupDetails extends Shape
{
    /**
     * @param array{
     ...
     *     EnvironmentConfig?: EnvironmentConfigDetails|null
     * } $args
     */
