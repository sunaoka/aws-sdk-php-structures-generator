 ...
 * @property list<'training-job'|'hyperpod-cluster'|'endpoint'|'studio-apps'> $TargetResources
...
class TrainingPlanOffering extends Shape
{
     ...
     *     TargetResources: list<'training-job'|'hyperpod-cluster'|'endpoint'|'studio-apps'>,
