 ...
 * @property float $InitialVariantWeight
 * @property 'ml.eia1.medium'|'ml.eia1.large'|'ml.eia1.xlarge'|'ml.eia2.medium'|'ml.eia2.large'|'ml.eia2.xlarge' $AcceleratorType
 * @property ProductionVariantCoreDumpConfig $CoreDumpConfig
 * @property ProductionVariantServerlessConfig $ServerlessConfig
 * @property int<1, 512> $VolumeSizeInGB
 * @property int<60, 3600> $ModelDataDownloadTimeoutInSeconds
 * @property int<60, 3600> $ContainerStartupHealthCheckTimeoutInSeconds
 * @property bool $EnableSSMAccess
 ...
 * @property 'al2-ami-sagemaker-inference-gpu-2' $InferenceAmiVersion
 */
