...
/**
 * @property int<0, 6758> $InstanceCount
 * @property int<0, 6758>|null $MinInstanceCount
 ...
 * @property ClusterInstanceRequirements|null $InstanceRequirements
...
class ClusterInstanceGroupSpecification extends Shape
{
    /**
     * @param array{
     *     InstanceCount: int<0, 6758>,
     *     MinInstanceCount?: int<0, 6758>|null,
     ...
     *     InstanceRequirements?: ClusterInstanceRequirements|null,
