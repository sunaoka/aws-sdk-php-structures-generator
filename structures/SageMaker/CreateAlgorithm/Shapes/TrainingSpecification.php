 ...
 * @property string $TrainingImageDigest
 * @property list<HyperParameterSpecification> $SupportedHyperParameters
 ...
 * @property bool $SupportsDistributedTraining
 * @property list<MetricDefinition> $MetricDefinitions
 * @property list<ChannelSpecification> $TrainingChannels
 * @property list<HyperParameterTuningJobObjective> $SupportedTuningJobObjectiveMetrics
