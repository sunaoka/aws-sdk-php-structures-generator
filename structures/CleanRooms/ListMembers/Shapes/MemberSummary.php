 ...
 * @property list<'CAN_QUERY'|'CAN_RECEIVE_RESULTS'|'CAN_RUN_JOB'|'CAN_EXPORT_QUERY_ANALYSIS_LOG'> $abilities
...
class MemberSummary extends Shape
{
     ...
     *     displayName: string,
     *     abilities: list<'CAN_QUERY'|'CAN_RECEIVE_RESULTS'|'CAN_RUN_JOB'|'CAN_EXPORT_QUERY_ANALYSIS_LOG'>,
