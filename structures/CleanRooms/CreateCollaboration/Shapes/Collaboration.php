...
class Collaboration extends Shape
{
     ...
     *     autoApprovedChangeTypes?: list<'ADD_MEMBER'|'GRANT_RECEIVE_RESULTS_ABILITY'|'REVOKE_RECEIVE_RESULTS_ABILITY'|'GRANT_EXPORT_QUERY_ANALYSIS_LOG_ABILITY'|'REVOKE_EXPORT_QUERY_ANALYSIS_LOG_ABILITY'>|null,
