...
namespace Sunaoka\Aws\Structures\AppSync\UpdateApiCache\Shapes;

use Sunaoka\Aws\Structures\Shape;

/**
 * @property int|null $ttl
 * @property 'FULL_REQUEST_CACHING'|'PER_RESOLVER_CACHING'|'OPERATION_LEVEL_CACHING'|null $apiCachingBehavior
...
class ApiCache extends Shape
{
     ...
     * @param array{
     *     ttl?: int|null,
     *     apiCachingBehavior?: 'FULL_REQUEST_CACHING'|'PER_RESOLVER_CACHING'|'OPERATION_LEVEL_CACHING'|null,
