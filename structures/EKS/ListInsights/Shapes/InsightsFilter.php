...
/**
 * @property list<'UPGRADE_READINESS'|'MISCONFIGURATION'|'ROLLBACK_READINESS'>|null $categories
...
class InsightsFilter extends Shape
{
    /**
     * @param array{
     *     categories?: list<'UPGRADE_READINESS'|'MISCONFIGURATION'|'ROLLBACK_READINESS'>|null,
