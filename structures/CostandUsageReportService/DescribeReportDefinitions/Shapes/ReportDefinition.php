...
namespace Sunaoka\Aws\Structures\CostandUsageReportService\DescribeReportDefinitions\Shapes;
 ...
 * @property list<'REDSHIFT'|'QUICKSIGHT'|'ATHENA'> $AdditionalArtifacts
 * @property bool $RefreshClosedReports
 * @property 'CREATE_NEW_REPORT'|'OVERWRITE_REPORT' $ReportVersioning
...
class ReportDefinition extends Shape
{
     ...
     *     AdditionalArtifacts?: list<'REDSHIFT'|'QUICKSIGHT'|'ATHENA'>,
