...
/**
 * @property 'PROVISIONING'|'BOOTSTRAPPING'|'RUNNING'|'RESIZING'|'RECONFIGURING'|'SUSPENDED'|'TERMINATING'|'TERMINATED'|null $State
...
class InstanceFleetStatus extends Shape
{
    /**
     * @param array{
     *     State?: 'PROVISIONING'|'BOOTSTRAPPING'|'RUNNING'|'RESIZING'|'RECONFIGURING'|'SUSPENDED'|'TERMINATING'|'TERMINATED'|null,
