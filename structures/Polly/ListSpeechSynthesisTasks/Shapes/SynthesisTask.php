...
namespace Sunaoka\Aws\Structures\Polly\ListSpeechSynthesisTasks\Shapes;
 ...
 * @property 'json'|'mp3'|'ogg_opus'|'ogg_vorbis'|'pcm'|'mulaw'|'alaw'|null $OutputFormat
