...
class VerifiedPermissionsClient extends \Aws\VerifiedPermissions\VerifiedPermissionsClient
{
    ...
    use CreatePolicyStoreAlias\CreatePolicyStoreAliasTrait;
    ...
    use DeletePolicyStoreAlias\DeletePolicyStoreAliasTrait;
    ...
    use GetPolicyStoreAlias\GetPolicyStoreAliasTrait;
    ...
    use ListPolicyStoreAliases\ListPolicyStoreAliasesTrait;
