 ...
 * @property list<'IN_SYNC'|'MODIFIED'|'DELETED'|'NOT_CHECKED'|'UNKNOWN'|'UNSUPPORTED'>|null $StackInstanceResourceDriftStatuses
...
class ListStackInstanceResourceDriftsRequest extends Request
{
     ...
     *     StackInstanceResourceDriftStatuses?: list<'IN_SYNC'|'MODIFIED'|'DELETED'|'NOT_CHECKED'|'UNKNOWN'|'UNSUPPORTED'>|null,
