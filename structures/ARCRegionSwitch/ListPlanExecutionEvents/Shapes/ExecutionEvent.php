 ...
 * @property 'CustomActionLambda'|'ManualApproval'|'AuroraGlobalDatabase'|'EC2AutoScaling'|'ARCRoutingControl'|'ARCRegionSwitchPlan'|'Parallel'|'ECSServiceScaling'|'EKSResourceScaling'|'Route53HealthCheck'|'DocumentDb'|'RdsPromoteReadReplica'|'RdsCreateCrossRegionReplica'|'LambdaEventSourceMapping'|null $executionBlockType
...
class ExecutionEvent extends Shape
{
     ...
     *     executionBlockType?: 'CustomActionLambda'|'ManualApproval'|'AuroraGlobalDatabase'|'EC2AutoScaling'|'ARCRoutingControl'|'ARCRegionSwitchPlan'|'Parallel'|'ECSServiceScaling'|'EKSResourceScaling'|'Route53HealthCheck'|'DocumentDb'|'RdsPromoteReadReplica'|'RdsCreateCrossRegionReplica'|'LambdaEventSourceMapping'|null,
