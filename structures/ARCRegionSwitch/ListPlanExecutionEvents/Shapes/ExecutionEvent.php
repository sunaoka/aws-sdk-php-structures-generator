 ...
 * @property 'CustomActionLambda'|'ManualApproval'|'AuroraGlobalDatabase'|'EC2AutoScaling'|'ARCRoutingControl'|'ARCRegionSwitchPlan'|'Parallel'|'ECSServiceScaling'|'EKSResourceScaling'|'Route53HealthCheck'|'DocumentDb'|'RdsPromoteReadReplica'|'RdsCreateCrossRegionReplica'|'LambdaEventSourceMapping'|'AuroraServerlessScaling'|'AuroraProvisionedScaling'|'NeptuneGlobalDatabase'|'RdsSwitchoverReadReplica'|null $executionBlockType
