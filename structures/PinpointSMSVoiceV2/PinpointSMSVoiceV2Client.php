...
class PinpointSMSVoiceV2Client extends \Aws\PinpointSMSVoiceV2\PinpointSMSVoiceV2Client
{
    ...
    use CreateNotifyConfiguration\CreateNotifyConfigurationTrait;
    ...
    use CreateRcsAgent\CreateRcsAgentTrait;
    ...
    use DeleteNotifyConfiguration\DeleteNotifyConfigurationTrait;
    use DeleteNotifyMessageSpendLimitOverride\DeleteNotifyMessageSpendLimitOverrideTrait;
    ...
    use DescribeNotifyConfigurations\DescribeNotifyConfigurationsTrait;
    use DescribeNotifyTemplates\DescribeNotifyTemplatesTrait;
    ...
    use DescribeRcsAgentCountryLaunchStatus\DescribeRcsAgentCountryLaunchStatusTrait;
    use DescribeRcsAgents\DescribeRcsAgentsTrait;
    ...
    use UpdateNotifyConfiguration\UpdateNotifyConfigurationTrait;
    ...
    use UpdateRcsAgent\UpdateRcsAgentTrait;
