...
class OmicsClient extends \Aws\Omics\OmicsClient
{
    ...
    use CancelRunBatch\CancelRunBatchTrait;
    ...
    use DeleteRunBatch\DeleteRunBatchTrait;
    ...
    use ListRunsInBatch\ListRunsInBatchTrait;
    ...
    use StartRunBatch\StartRunBatchTrait;
