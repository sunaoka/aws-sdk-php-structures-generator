...
namespace Sunaoka\Aws\Structures\OpenSearchService\DescribeReservedInstances\Shapes;
 ...
 * @property int|null $BillingSubscriptionId
 ...
 */
class ReservedInstance extends Shape
{
    /**
     * @param array{
