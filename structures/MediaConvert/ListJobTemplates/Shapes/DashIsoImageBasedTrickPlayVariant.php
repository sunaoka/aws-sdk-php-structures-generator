...
/**
 * @property 'FOLLOW_IFRAME'|'FOLLOW_CUSTOM'|'FOLLOW_SEGMENTATION'|null $IntervalCadence
 ...
 */
class DashIsoImageBasedTrickPlayVariant extends Shape
{
    /**
     * @param array{
     *     IntervalCadence?: 'FOLLOW_IFRAME'|'FOLLOW_CUSTOM'|'FOLLOW_SEGMENTATION'|null,
