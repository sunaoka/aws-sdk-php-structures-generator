...
/**
 * @property 'DISABLED'|'AUTO'|'TRACK'|'FRAME'|'FORCE' $AudioDurationCorrection
 * @property string $CustomLanguageCode
 * @property 'DEFAULT'|'NOT_DEFAULT' $DefaultSelection
 * @property string $ExternalAudioFileInput
 * @property HlsRenditionGroupSettings $HlsRenditionGroupSettings
 ...
 * @property int<-2147483648, 2147483647> $Offset
 * @property list<int<1, 2147483647>> $Pids
 * @property int<0, 8> $ProgramSelection
 * @property RemixSettings $RemixSettings
 * @property 'PID'|'TRACK'|'LANGUAGE_CODE'|'HLS_RENDITION_GROUP' $SelectorType
 * @property list<int<1, 2147483647>> $Tracks
 */
class AudioSelector extends Shape
{
     ...
     *     Offset?: int<-2147483648, 2147483647>,
     *     Pids?: list<int<1, 2147483647>>,
     *     ProgramSelection?: int<0, 8>,
     *     RemixSettings?: RemixSettings,
     *     SelectorType?: 'PID'|'TRACK'|'LANGUAGE_CODE'|'HLS_RENDITION_GROUP',
     *     Tracks?: list<int<1, 2147483647>>
     * } $args
     */
