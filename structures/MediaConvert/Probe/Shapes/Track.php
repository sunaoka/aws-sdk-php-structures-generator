 ...
 * @property 'UNKNOWN'|'AAC'|'AC3'|'EAC3'|'FLAC'|'MP3'|'OPUS'|'PCM'|'VORBIS'|'AV1'|'AVC'|'HEVC'|'JPEG2000'|'MJPEG'|'MPEG1'|'MP4V'|'MPEG2'|'PRORES'|'QTRLE'|'THEORA'|'UNCOMPRESSED'|'VFW'|'VP8'|'VP9'|'C608'|'C708'|'WEBVTT'|null $Codec
...
class Track extends Shape
{
     ...
     *     Codec?: 'UNKNOWN'|'AAC'|'AC3'|'EAC3'|'FLAC'|'MP3'|'OPUS'|'PCM'|'VORBIS'|'AV1'|'AVC'|'HEVC'|'JPEG2000'|'MJPEG'|'MPEG1'|'MP4V'|'MPEG2'|'PRORES'|'QTRLE'|'THEORA'|'UNCOMPRESSED'|'VFW'|'VP8'|'VP9'|'C608'|'C708'|'WEBVTT'|null,
