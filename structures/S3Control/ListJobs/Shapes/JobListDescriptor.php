 ...
 * @property 'LambdaInvoke'|'S3PutObjectCopy'|'S3PutObjectAcl'|'S3PutObjectTagging'|'S3DeleteObjectTagging'|'S3InitiateRestoreObject'|'S3PutObjectLegalHold'|'S3PutObjectRetention'|'S3ReplicateObject'|'S3ComputeObjectChecksum'|'S3UpdateObjectEncryption'|null $Operation
...
class JobListDescriptor extends Shape
{
     ...
     *     Operation?: 'LambdaInvoke'|'S3PutObjectCopy'|'S3PutObjectAcl'|'S3PutObjectTagging'|'S3DeleteObjectTagging'|'S3InitiateRestoreObject'|'S3PutObjectLegalHold'|'S3PutObjectRetention'|'S3ReplicateObject'|'S3ComputeObjectChecksum'|'S3UpdateObjectEncryption'|null,
