...
{
    /**
     * @param array{eventConfigurations?: array<'THING'|'THING_GROUP'|'THING_TYPE'|'THING_GROUP_MEMBERSHIP'|'THING_GROUP_HIERARCHY'|'THING_TYPE_ASSOCIATION'|'JOB'|'JOB_EXECUTION'|'POLICY'|'CERTIFICATE'|'CA_CERTIFICATE', Shapes\Configuration>|null} $args
     */
