 ...
 * @property \Psr\Http\Message\StreamInterface|null $B
 * @property list<string>|null $SS
 * @property list<string>|null $NS
 * @property list<\Psr\Http\Message\StreamInterface>|null $BS
...
class AttributeValue extends Shape
{
     ...
     *     S?: string|null,
     *     N?: string|null,
     *     B?: \Psr\Http\Message\StreamInterface|null,
     *     SS?: list<string>|null,
     *     NS?: list<string>|null,
     *     BS?: list<\Psr\Http\Message\StreamInterface>|null,
