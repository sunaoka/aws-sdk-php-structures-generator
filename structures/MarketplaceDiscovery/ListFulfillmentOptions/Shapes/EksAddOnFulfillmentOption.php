 ...
 * @property list<EksAddOnOperatingSystem>|null $operatingSystems
 ...
 */
class EksAddOnFulfillmentOption extends Shape
{
    /**
     * @param array{
     ...
     *     operatingSystems?: list<EksAddOnOperatingSystem>|null,
