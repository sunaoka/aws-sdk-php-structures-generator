 ...
 * @property 'Ec2Instance'|'AutoScalingGroup'|'EbsVolume'|'LambdaFunction'|'EcsService'|'License'|'RdsDBInstance'|'RdsDBInstanceStorage'|'AuroraDBClusterStorage'|'NatGateway'|'DynamoDBTable'|'ElastiCacheCluster'|'MemoryDBCluster'|'DocumentDBCluster'|'WorkSpaces'|'SageMakerEndpoint'|null $recommendationResourceType
...
class RecommendationSummary extends Shape
{
     ...
     *     recommendationResourceType?: 'Ec2Instance'|'AutoScalingGroup'|'EbsVolume'|'LambdaFunction'|'EcsService'|'License'|'RdsDBInstance'|'RdsDBInstanceStorage'|'AuroraDBClusterStorage'|'NatGateway'|'DynamoDBTable'|'ElastiCacheCluster'|'MemoryDBCluster'|'DocumentDBCluster'|'WorkSpaces'|'SageMakerEndpoint'|null,
