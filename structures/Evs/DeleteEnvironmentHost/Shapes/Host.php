...
namespace Sunaoka\Aws\Structures\Evs\DeleteEnvironmentHost\Shapes;
 ...
 * @property 'i4i.metal'|'i7i.metal-24xl'|'i7i.metal-48xl'|null $instanceType
...
class Host extends Shape
{
     ...
     *     keyName?: string|null,
     *     instanceType?: 'i4i.metal'|'i7i.metal-24xl'|'i7i.metal-48xl'|null,
