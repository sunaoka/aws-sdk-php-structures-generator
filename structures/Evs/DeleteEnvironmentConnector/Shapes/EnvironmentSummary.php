...
namespace Sunaoka\Aws\Structures\Evs\DeleteEnvironmentConnector\Shapes;
 ...
 * @property 'VCF-5.2.1'|'VCF-5.2.2'|'SELF_DEPLOYED'|null $vcfVersion
...
class EnvironmentSummary extends Shape
{
     ...
     *     vcfVersion?: 'VCF-5.2.1'|'VCF-5.2.2'|'SELF_DEPLOYED'|null,
