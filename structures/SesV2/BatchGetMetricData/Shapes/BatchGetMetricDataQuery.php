 ...
 * @property array<'EMAIL_IDENTITY'|'CONFIGURATION_SET'|'ISP'|'TENANT_NAME', string>|null $Dimensions
...
class BatchGetMetricDataQuery extends Shape
{
     ...
     *     Dimensions?: array<'EMAIL_IDENTITY'|'CONFIGURATION_SET'|'ISP'|'TENANT_NAME', string>|null,
