 ...
 * @property list<string>|null $EligiblePrograms
 * @property string|null $PublicProfileSummary
 */
class ProspectingResultCustomer extends Shape
{
    /**
     * @param array{
     ...
     *     EligiblePrograms?: list<string>|null,
